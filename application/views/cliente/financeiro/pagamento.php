              ...
              <div class="col-md-6 col-sm-6">
                  <div class="panel short-states bg-danger">
                      ...
                      <div class="panel-body">
                          ...
                          <strong class="text-uppercase">Rendimentos</strong>
                      </div>
                  </div>
              </div>
              <div class="col-md-6 col-sm-6">
                    ...
                    <section class="panel">
                        ...
                        <form class="form-horizontal form-variance">
                          ...
                          <div class="form-group">
                                <label class="col-sm-3 control-label">ID da Fatura</label>
                                <div class="col-sm-6">
                                    <div class="col-sm-10">
                                      <input class="form-control u-rounded" id="id_fatura" type="text" style="margin-bottom:0">
                                      <span class="help-block">Informe a ID da fatura que deseja pagar</span>
                                    </div>
                                    <div class="col-sm-2">
                          ...
                          <div id="bloco_confirmacao" style="display:none;">
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-6">
                                      R$ <span id="valor_fatura"></span>
                                  </div>
                            </div>

                            <div class="form-group">
                                  <label class="col-sm-3 control-label">Pagar com</label>
                                  <div class="col-sm-6">
