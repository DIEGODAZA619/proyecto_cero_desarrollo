...
<div id="content" class="ui-content">
    <div class="ui-content-body">
        <div class="ui-container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <h1 class="page-title"> Níveles
                        <small>todos los níveles de indicación del sistema</small>
                    </h1>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb pull-right">
                        <li>Home</li>
                        <li>Níveles</li>
                        <li><a href="<?php echo base_url('admin/niveis');?>" class="active">Todos Níveles</a></li>
                    </ul>
                </div>
            </div>
