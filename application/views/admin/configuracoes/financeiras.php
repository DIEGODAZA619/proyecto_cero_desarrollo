                        ...
                        <div class="tab-content clearfix">
                           <div class="tab-pane active" id="saques">
                              <div class="form-group">
                                 <label class="col-sm-3 control-label">Valor mínimo retirar rendimentos</label>
                                 <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                 <label class="col-sm-3 control-label">Valor mínimo retirar configuraciones</label>
                                 <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                 <label class="col-sm-3 control-label">Taza de Retiro</label>
                                 <div class="col-sm-6">
