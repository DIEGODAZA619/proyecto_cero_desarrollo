            ...
            <div class="row">
                <div class="col-md-8">
                    <h1 class="page-title"> Configuraciones de email
                        <small>todas as configuraciones de email</small>
                    </h1>
                </div>
                <div class="col-md-4">
                    ...
                    <section class="panel">
                        ...
                        <form action="" method="post" class="form-horizontal form-variance" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Email de Remetente</label>
                              <div class="col-sm-6">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <input type="submit" name="submit" class="btn btn-success" value="Atualizar configuraciones">
                              </div>
                          </div>
