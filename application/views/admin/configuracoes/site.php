                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <form action="" method="post" class="form-horizontal form-variance" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Máximo de CPF por conta</label>
                              <div class="col-sm-6">
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Patrocinador Padrão</label>
                              <div class="col-sm-6">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <input type="submit" name="submit" class="btn btn-success" value="Atualizar configuración">
                              </div>
                          </div>
