                        ...
                        <form action="" method="post" class="form-horizontal form-variance">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    ...
                                    <input type="radio" name="rede" value="0" <?php echo ($plano->rede_afiliados == 0) ? 'checked' : '';?>> Não
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Ganancias Diários</label>
                              <div class="col-sm-6">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    ...
                                    <input type="radio" name="recomendado" value="0" <?php echo ($plano->recomendado == 0) ? 'checked' : '';?>> Não
                              </div>
                          </div>
