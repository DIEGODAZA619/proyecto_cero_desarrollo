                        ...
                        <form action="" method="post" class="form-horizontal form-variance">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    ...
                                    <input type="radio" name="tipo" value="2" <?php echo ($conta->categoria_conta == 2) ? 'checked' : '';?>> Bitcoin
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <input type="submit" name="submit" class="btn btn-success" value="Editar Pago">
                              </div>
                          </div>
