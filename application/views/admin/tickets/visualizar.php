                        ...
                        <div class="col-md-12">
                                <div class="panel">
                                    <header class="panel-heading">
                                        Assunto: <?php echo $tickets[0]->assunto;?>
                                        <?php
                                        if($tickets[0]->status != 3){
                                        ?>
                                        <a href="<?php echo base_url('admin/tickets/fechar/'.$tickets[0]->id_ticket);?>" class="btn btn-danger pull-right"><i class="fa fa-times"></i> Fechar Ticket</a>
                                        <?php
                                        }
                                        ?>
                                    </header>
                                    ...
                                    <div class="panel-footer">
                                        ...
                                        <div class="input-group srch-lg mbot-0">
                                            <input type="text" class="form-control" name="resposta" placeholder="Digite sua resposta aqui">
