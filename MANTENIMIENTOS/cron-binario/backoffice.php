...
<!--                                     <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <?php 
                                            ...
                                            ##### Calculo de puntos de transferencia ##### JVM #####
                                            $suma_points_transfer = $saldo_pontos['transferir']['esquerdo'] + $saldo_pontos['transferir']['direito'];
                                            ##### Calculo de puntos de transferencia ##### JVM #####
			...
			<?php ##### Puntos de transferencia ##### JVM ##### ?>
			<div class="col-12 col-md-4 col-xl-4 p-3">
                        ...
                        <table class="table table-sm table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo number_format($saldo_pontos['transferir']['esquerdo'], 0, ".", "."); ?>
                                    </td>
                                    <td>
                                        <?php echo number_format($saldo_pontos['transferir']['direito'], 0, ".", "."); ?>
                                    </td>
                                    <td>
                                        <?php echo number_format($saldo_pontos['transferir']['esquerdo'] + $saldo_pontos['transferir']['direito'], 0, ".", "."); ?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="content style-content py-4 px-4 position-relative text-center ">
                        ...
                        <div class="detalle row position-relative w-100">
                            <div class="text-end">
                                ...
                                <div class="linea"></div>
                                <?php
                                   ##### Verificación de valor porcentaje #####JVM#####
                                if (consultaPlanGanancias(InformacoesUsuario('id')) > 0) {
                            ...
                            <div class="col-sm-2 d-flex align-items-center justify-content-center">
                                ...
                                <div>
                                    <!-- ##### Muestra valor maximo #####JVM#####-->
                                    <span style="color: white; font-size: 20px; font-weight: bold;"><?= $usrpln['ganhos_maximo'] ?>
                                    </span>
                                    <!-- ##### Muestra valor maximo #####JVM#####-->
	  ...
	  <div class="col-12 col-xs-12 col-sm-12 col-md-7 col-lg-7 p-3" id="notiSystem">
                    <div class="content style-content py-4 px-4 position-relative">
						...
						<h2><center><?=number_format(ConfiguracoesSistema('porcentagem_dia'),2,',','.')?> %</center></h2>
                            ...
                            <div class="col-12 mt-3">
                                <h1 class="light-txt" id="fim_plano"></h1>
                                <strong class="text-uppercase">Daily Income profit</strong>
